    ...
    <div className="relative w-48">
      ...
      {isOpen &&
        createPortal(
          <div
            ref={ref}
            className="absolute z-[9999] w-44 rounded-2xl border border-gray-100 bg-white p-4 shadow-xl"
            style={{
              top: `${coords.top}px`,
              left: `${coords.left}px`,
          ...
          >
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-lg py-1.5 text-center text-sm font-semibold transition ${
                          selectedHour === hour
                            ? "bg-teal-50 font-bold text-blue-500"
            ...
            <button
              ...
              onClick={handleApply}
              className="mt-3 w-full cursor-pointer rounded-xl bg-blue-500 py-2 text-sm font-medium text-white transition hover:bg-blue-600"
            >
              확인
            </button>
          </div>,
